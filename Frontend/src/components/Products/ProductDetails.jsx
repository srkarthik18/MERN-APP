...
const selectedProduct = {
  ...
  originalPrice: 99.99,
  description:
    'A stylish jacket perfect for all seasons. Made with high-quality materials, it offers both comfort and style.',
  brand: 'FashionBrand',
  material: 'Leather',
  sizes: ['S', 'M', 'L', 'XL'],
  ...
  images: [
    ...
    },
    {
      ...
      altTxt: 'Stylish Jacket Back View'
    }
  ]
}
...
const similiarProducts = [
  ...
  },
  {
    ...
    price: 89.99,
    images: [
      { url: 'https://picsum.photos/500/500?random=4', altTxt: 'Leather Shoes' }
    ]
  },
  {
    _id: '3',
