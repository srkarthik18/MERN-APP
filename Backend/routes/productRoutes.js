...
router.get('/', async (req, res) => {
  try {
    ...
    // Sorting logic as per search params
    let sort = {}
    if (sortBy) {
      switch (sortBy) {
        case 'priceAsc':
...
// @desc Retrives the products with highest rating
// @access Public
...
// @desc Retrives the similar products based on the current product's gender and category
// @access Public
